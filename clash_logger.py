...
#PLAYER_TAG_RAW = os.environ.get("CR_PLAYER_TAG", "#YJPUJ9PU").strip()
#BEARER_TOKEN = os.environ.get("CR_BEARER_TOKEN", "abcd").strip()
PLAYER_TAG_RAW = "#YJPUJ9PU"
BEARER_TOKEN = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9..7ZiaVRtpyLIZdtERkeOGwLaupeGZDaM_izmNFxJJTeEB6weridSkEO4EjzTQpNLDjbRA0D721ot3VqpJtrlM1w"
